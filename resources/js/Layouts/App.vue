...
<div class="c-app">
    ...
    <div class="c-sidebar-brand d-lg-down-none" style="background: #894b9d;">
        <img src="/images/cash-machine.png" class="bg-light rounded shadow-sm p-1" width="35"> <span class="ml-2 font-weight-bold">POS - Point Of Sales</span>
    </div>
    ...
    <div class="c-body">
        ...
        <div><strong>POS</strong> &copy; 2024 - R3.com.</div>
        </footer>
    </div>
    </div>
</div>
